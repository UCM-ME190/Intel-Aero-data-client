...
def process_average_depth(average_depth):
...
while True:
    ...
    rgb, depth, time_stamp, average_depth = get_rgb_depth_time(byte_data)
    process_average_depth(average_depth)
